...
class _CppLintState:
    ...
    def AddJUnitFailure(self, filename, linenum, message, category, confidence) -> None: ...
...
def CheckForMultilineCommentsAndStrings(filename, clean_lines, linenum, error) -> None: ...
...
def CheckForNonStandardConstructs(filename, clean_lines, linenum, nesting_state, error) -> None: ...
def CheckSpacingForFunctionCall(filename, clean_lines, linenum, error) -> None: ...
def IsBlankLine(line): ...
def CheckForNamespaceIndentation(filename, nesting_state, clean_lines, line, error) -> None: ...
def CheckForFunctionLengths(filename, clean_lines, linenum, function_state, error) -> None: ...
...
def CheckBracesSpacing(filename, clean_lines, linenum, nesting_state, error) -> None: ...
...
def CheckStyle(filename, clean_lines, linenum, file_extension, nesting_state, error) -> None: ...
def CheckIncludeLine(filename, clean_lines, linenum, include_state, error) -> None: ...
def CheckLanguage(filename, clean_lines, linenum, file_extension, include_state, nesting_state, error) -> None: ...
...
def CheckForNonConstReference(filename, clean_lines, linenum, nesting_state, error) -> None: ...
...
def CheckForIncludeWhatYouUse(filename, clean_lines, include_state, error, io=...) -> None: ...
...
def CheckItemIndentationInNamespace(filename, raw_lines_no_comments, linenum, error) -> None: ...
def ProcessLine(filename, file_extension, clean_lines, line, include_state, function_state, nesting_state, error, extra_check_functions: Incomplete | None = ...) -> None: ...
...
def ProcessFileData(filename, file_extension, lines, error, extra_check_functions: Incomplete | None = ...) -> None: ...
def ProcessConfigOverrides(filename): ...
def ProcessFile(filename, vlevel, extra_check_functions: Incomplete | None = ...) -> None: ...
