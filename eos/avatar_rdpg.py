...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="mongo_local",
        help="url for mongodb server in format usr:password@host:port, e.g. admint:y02ydhVqDj3QFjT@10.10.0.4:23000, "
        "or simply name with synced default config, e.g. mongo_cluster, mongo_local; if specified as empty "
        "string '', use local npy file",
    )
