# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/01.avatar.ipynb.

# %% auto 0
__all__ = ['proj_root', 'parser', 'Avatar', 'main']

# %% ../nbs/01.avatar.ipynb 3
import abc
import argparse
...
# %% ../nbs/01.avatar.ipynb 4
from data_io_nbdev.agent.dpg import DPG
from data_io_nbdev.agent.ddpg import DDPG 
from data_io_nbdev.agent.rdpg.rdpg import RDPG
from data_io_nbdev.agent.utils.hyperparams import HyperParamDDPG, HyperParamRDPG

from data_io_nbdev.config.vehicles import TruckInField, TruckInCloud
from data_io_nbdev.config.drivers import Driver
from data_io_nbdev.config.messengers import CANMessenger, TripMessenger
from data_io_nbdev.config.utils import ( 
    str_to_can_server, 
    str_to_driver,
    str_to_trip_server,
    str_to_truck,
...
from data_io_nbdev.dataflow.cloud import Cloud
from data_io_nbdev.dataflow.cruncher import Cruncher
from data_io_nbdev.dataflow.kvaser import Kvaser
from data_io_nbdev.dataflow.pipeline.queue import Pipeline
from data_io_nbdev.system.log import set_root_logger
from data_io_nbdev.system.graceful_killer import GracefulKiller

# %% ../nbs/01.avatar.ipynb 5
proj_root = Path(os.path.abspath(os.path.join(os.getcwd(), "../..")))
proj_root


# %% ../nbs/01.avatar.ipynb 9
