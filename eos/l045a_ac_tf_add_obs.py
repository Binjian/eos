...
num_observations = 3  # observed are the current speed and throttle; !! acceleration not available in l045a
        ...
        with tf.GradientTape() as tape:
            while (
                ...
                motionpower_states = tf.convert_to_tensor(
                    motionpower
                )  # state must have 30 (velocity, pedal, brake, current, voltage) 5 tuple
