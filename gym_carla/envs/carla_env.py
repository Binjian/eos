...
class CarlaEnv(gym.Env):
  ...
  def __init__(self, params):
    ...
    # newcam sensor
    self.newcam_img = np.zeros((2 * self.obs_size, 2 * self.obs_size, 3), dtype=np.uint8)
  ...
  def toggle_camera(self):
    ...
    self.newcam_sensor = self.world.spawn_actor(self.newcam_bp, self.newcam_trans, attach_to=self.ego)
